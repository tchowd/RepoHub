    ...
    <Box 
      ...
      <Tabs variant='soft-rounded' colorScheme='green'>
        ...
        <TabPanels>
            ...
            Check out the Polygon community on Discord - hang out with 37756 other members and enjoy free voice and text chat.
            </Text>
            ...
            <TabPanel>
                ...
                <Text as="p" fontSize="md" marginTop="2">
                Here are all the Polygon Technology repositories. Learn more here.
                </Text>
                <Button height={'2rem'} marginTop={'1rem'}>Read more</Button>
            ...
            <TabPanel>
                ...
                <Text as="p" fontSize="md" marginTop="2">
                Questions tagged [polygon]. Questions related to development on the Polygon EVM-enabled sidechain.
